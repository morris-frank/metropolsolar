...
//
//$unique_id = uniqid('mod_simplecalendar_');
//$thatId = $params->get('thatId', 1);
...
//JRequest::setVar('id', $thatId);
//$lang = JFactory::getLanguage();
//$lang->load('com_simplecalendar', JPATH_SITE);
//if (!class_exists('SimpleCalendarController')) {
//    require_once (JPATH_SITE .'/components/com_simplecalendar/controller.php');
//}
...
JRequest::setVar('view', 'simplecalendar');
JRequest::setVar('layout', 'default');
JRequest::setVar('task', 'display');
